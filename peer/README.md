...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/bitweb-project/bted/peer)
...
* [New Outbound Peer Example](https://pkg.go.dev/github.com/bitweb-project/bted/peer#example-package--NewOutboundPeer)  
